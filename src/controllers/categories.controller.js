 ...
 *     tags:
 *       - admin/categories
 *     description: Retrieve list categories data with pagination support
 *     parameters:
 *       - in: query
 *         name: page
 *         schema:
...
export async function listCategories(req, res) {
  try {
    ...
    const totalData = await getTotalDataCategories(search);
    ...
    const categories = await getListAllCategories(page, limit, search);
